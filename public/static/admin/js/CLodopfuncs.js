(function (win) {
        var CLODOP = {
        strWebPageID:"3E3AAAM",strTaskID:"",strHostURI:"http://192.168.1.71:8000",
        VERSION:"6.5.0.2",IVERSION:"6502",CVERSION:"4.0.8.8",HTTPS_STATUS:2,VERSION_EXT:true,
        iBaseTask:0,timeThreshold:5,Priority:0,blIslocal:false,
                ...
                function() {
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt=new WebSocket('ws://192.168.1.71:8000/c_webskt/');
