<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\xampp\htdocs\tplay\public/../app/index\view\login\dl.html";i:1551491789;s:55:"D:\xampp\htdocs\tplay\app\index\view\common\header.html";i:1551494392;s:55:"D:\xampp\htdocs\tplay\app\index\view\common\footer.html";i:1551504296;}*/ ?>
<!-- 头部公共文件 -->
...
<div class="wrap">
    <div class="dl-box">
        <div class="content fix">
            <div class="dl-box-shu">
                <div class="dl-tab fix">
                    <p class="on">帐号登录</p>
                    <span>|</span>
                    <p>扫码登录</p>
                </div>
                <div class="dl-switch" style="display:block;">
                    <form action="/index/login/yz" method="post">
                        <div class="shu-ru fix">
                            <input name="name" type="text" class="text" placeholder="用户名" />
                        </div>
                        <div class="shu-ru fix">
                            <input name="upaw" type="password" class="text" placeholder="密码" />
                        </div>
                        <div class="shu-ru fix">
                        ...
                        <label class="label"><input name="Fruit" type="checkbox" value="" />记住用户名</label> 
                        <button class="butt" type="submit">登录</button>
                        <div class="wang">
                            <a href="index/login/index">立即注册</a>  |  <a href="">忘记密码？</a>
                        </div>
                        <div class="dl-qita">
                            <div class="dl-title">
                                <h5>其他方式登录</h5>
                            ...
                            <ul class="fix">
                                <li><a href=""><img src="/static/home/images/dl-qq.jpg" /></a></li>
                                <li><a href=""><img src="/static/home/images/dl-wb.jpg" /></a></li>
                                <li><a href=""><img src="/static/home/images/dl-zfb.jpg" /></a></li>
                                <li><a href=""><img src="/static/home/images/dl-wx.jpg" /></a></li>
                            </ul>
                        </div>
                    </form>
                </div>
                
                <div class="dl-switch" style="display:none;">
                    <div class="sao">
                        <img src="/static/home/images/timg.jpg" />                        
                        <p>扫一扫立即登录</p>
                    </div>
