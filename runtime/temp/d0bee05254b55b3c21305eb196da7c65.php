<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\xampp\htdocs\tplay\public/../app/admin\view\goods\index.html";i:1551854529;s:53:"D:\xampp\htdocs\tplay\app\admin\view\public\foot.html";i:1546481687;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="padding:10px;">
  <div class="tplay-body-div">
    <div class="layui-tab">
      ...
      <form class="layui-form serch" action="<?php echo url('admin/goods/index'); ?>" method="post">
        ...
        <tr>
          ...
          <td class="operation-menu">
            <div class="layui-btn-group">
              <a href="<?php echo url('admin/goods/publish',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-xs a_menu layui-btn-primary" style="margin-right: 0;font-size:12px;"><i class="layui-icon"></i></a>
              <a href="<?php echo url('admin/goods/addimg',['id'=>$vo['id']]); ?>" title="添加图片" class="layui-btn layui-btn-xs a_menu layui-btn-primary" style="margin-right: 0;font-size:12px;"><i class="layui-icon" ></i></a>  
    ...
    $('.is_top').click(function(){
      ...
      $.ajax({
        type:"post",
        url:"<?php echo url('admin/goods/is_top'); ?>",
    ...
    $('.status').click(function(){
      ...
      $.ajax({
        type:"post",
        url:"<?php echo url('admin/goods/status'); ?>",
