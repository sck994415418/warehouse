<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\Users\Administrator\Desktop\jiaoyu\jiaoyu\public/../app/admin\view\zixun\index.html";i:1564383308;s:76:"C:\Users\Administrator\Desktop\jiaoyu\jiaoyu\app\admin\view\public\foot.html";i:1546481687;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="tplay-body-div">
    ...
    <table class="layui-table" lay-size="sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php if($vo['age']): ?><?php echo $vo['age']; else: ?>未知<?php endif; ?></td>
          <td><?php if($vo['xueli']): ?><?php echo $vo['xueli']; else: ?>未知<?php endif; ?></td>
          <td><?php if($vo['zuanye'] == 1): ?>医药卫生专业<?php else: ?>未知<?php endif; ?></td>
          <td><?php if($vo['years'] == 1): ?><?php echo $vo['years']; else: ?>未知<?php endif; ?></td>
    ...
    $('.delete').click(function(){
      ...
      layer.confirm('确定要删除?', function(index) {
        $.ajax({
          url:"<?php echo url('admin/zixun/delete'); ?>",
          data:{id:id},
          success:function(res) {
            layer.msg(res.msg);
            if(res.code == 1) {
