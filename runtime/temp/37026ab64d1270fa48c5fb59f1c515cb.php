<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"C:\Users\Administrator\Desktop\tplay\jiaoyu\public/../app/admin\view\admin\admin_cate_publish.html";i:1546481687;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="tplay-body-div">
    <div class="layui-tab">
      <ul class="layui-tab-title">
        <li><a href="<?php echo url('admin/admin/adminCate'); ?>" class="a_menu">角色管理</a></li>
    ...
    <form class="layui-form" id="admin">
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input name="name" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" type="text" <?php if(!(empty($info['cate']['name']) || (($info['cate']['name'] instanceof \think\Collection || $info['cate']['name'] instanceof \think\Paginator ) && $info['cate']['name']->isEmpty()))): ?>value="<?php echo $info['cate']['name']; ?>"<?php endif; ?>>
        </div>
      </div>
    ...
    <div class="layui-form-item layui-form-text">
      ...
      <div class="layui-input-block" style="max-width:500px;">
        <textarea placeholder="请输入内容" class="layui-textarea" name="desc"><?php if(!(empty($info['cate']['desc']) || (($info['cate']['desc'] instanceof \think\Collection || $info['cate']['desc'] instanceof \think\Paginator ) && $info['cate']['desc']->isEmpty()))): ?><?php echo $info['cate']['desc']; endif; ?></textarea>
      </div>
    </div>


    <?php if(!(empty($info['cate']) || (($info['cate'] instanceof \think\Collection || $info['cate'] instanceof \think\Paginator ) && $info['cate']->isEmpty()))): ?>
    <input type="hidden" name="id" value="<?php echo $info['cate']['id']; ?>">
    <?php endif; ?>
      <div class="layui-form-item">
      ...
      layui.use(['layer', 'form'], function() {
          ...
          $(window).on('load', function() {
              form.on('submit(admin)', function(data) {
                  $.ajax({
                      url:"<?php echo url('admin/admin/adminCatePublish'); ?>",
